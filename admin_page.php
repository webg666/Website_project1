...
?>
      ...
      <form  action="admin_page.php" method="Post" runat id="edit_form" class="pro" enctype="multipart/form-data">
        ...
        <div class="des">
          ...
          <input type="text" name="product_name" id="product_name" placeholder="<?php echo $row["product_name"]?>">
          <input type="number" name="price" id="price"  placeholder="$<?php echo $row["price"]?>" >
...
?>          
          ...
          <div class="pro_add">
            ...
            <input type="file" name="product_image" id="product_image" placeholder="Product Image" required hidden>
              <button id="img-background" onclick="upload_product()">
                    <a id="icon_img"><i class="gg-image"></i></a>
              </button>
